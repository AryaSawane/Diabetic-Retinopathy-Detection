    ...
    if uploaded_file is not None:
        ...
        if analyze_button and model is not None:
            with st.spinner("Analyzing retinal image..."):
                ...
                mild_confidence = float(prediction[0][0])  # Assuming 'Mild' is the first class (index 0)

                if mild_confidence > 0.3:  # If Mild confidence is greater than 30%
                    predicted_class = 'Mild'
                    confidence = mild_confidence
                else:
...
def about_page():
    ...
    with col1:
        ...
        <div class="info-card">
            ...
            <ul>
                <li><strong>Model Architecture:</strong> Efficientnet</li>
